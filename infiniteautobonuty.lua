...
game:GetService("CoreGui").RobloxPromptGui.promptOverlay.ChildAdded:Connect(function(child)
    if not hopserver and child.Name == 'ErrorPrompt' and child:FindFirstChild('MessageArea') and child.MessageArea:FindFirstChild("ErrorFrame") then
        print("Infinite Auto Bounty | Rejoin!")
...
function wEarn(targ, earn,total) 
    if getgenv().Setting.Webhook.Enabled and getgenv().killed ~= nil then
        local data = {
            ...
            ["embeds"] = {
                {
                    ["title"] = "**Infinite Hub  | Auto Bounty**",
                    ["color"] = 00000,
                    ["fields"] = {
                        {
                            ["name"] = "Account: ",
                    ...
                    ["thumbnail"] = {
                        ["url"] = "https://cdn.discordapp.com/attachments/1211171037253734442/1232331591745798154/Infinitehub.png?ex=662911bb&is=6627c03b&hm=ef332e35847802b926f1e46f673311a33ffe031b58947e4aca08ded103a82d29&",
                    },
                    ["footer"] = {
                        ["text"] = "Infinite Hub- .gg/baokhanh",
                    },
...
--- Counter
--- Load & Save Setting
local foldername = "Infinite Hub Auto Bounty"
...
--- Gui
InfiniteScreen = Instance.new("ScreenGui");
...
InfiniteScreen.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
InfiniteScreen.Name = "InfiniteScreen"
InfiniteScreen.Parent = game:GetService("CoreGui")
...
DropShadowHolder.Parent = InfiniteScreen

DropShadow.Image = "rbxassetid://791987067"
...
ImageHub.Image = "rbxassetid://716334809"
...
NameHub.Text = "Infinite Hub | Blox Fruits"
